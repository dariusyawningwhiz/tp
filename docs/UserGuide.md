...
Note: the inputs must follow the specified order. Category and description should be 1 word.  
There must be a space between `category/<CATEGORY>`, `desc/<DESCRIPTION>` and `amt/<AMOUNT>`
**Command:**
```plaintext
